...
public class ZomatoApp {
    ...
    private void initializeRestaurants() {
        ...
        restaurant1.addMenuItem(new MenuItem("P3", "Lassi", 40));
        restaurant1.addMenuItem(new MenuItem("P4", "Paneer Tikka", 150));
        restaurant1.addMenuItem(new MenuItem("P5", "Aloo Tikki", 30));
        ...
        restaurant2.addMenuItem(new MenuItem("P4", "Cold Coffee", 60));
        restaurant2.addMenuItem(new MenuItem("P5", "Rasgulla", 25));
        restaurant2.addMenuItem(new MenuItem("P6", "Kachori Sabzi", 70));
        ...
        restaurant3.addMenuItem(new MenuItem("P4", "Pongal", 85));
        restaurant3.addMenuItem(new MenuItem("P5", "Uttapam", 95));
        restaurant3.addMenuItem(new MenuItem("P6", "Mysore Pak", 50));
    ...
    public Order checkoutNow(User user, String orderType, PaymentStrategy paymentStrategy) {
        return checkout(user, orderType, paymentStrategy, new CurrOrderFactory());
    }
